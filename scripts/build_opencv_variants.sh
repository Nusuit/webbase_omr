#!/usr/bin/env bash
# Build OpenCV 4.10.0 as Emscripten static libraries in two variants:
...
# Run from project root: bash build_opencv_variants.sh
...
echo "  emcmake cmake -S . -B build_simd -DOPENCV_VARIANT=simd && cmake --build build_simd"
echo ""
echo "  # Build omr_threads.js/wasm:"
echo "  emcmake cmake -S . -B build_threads -DOPENCV_VARIANT=threads && cmake --build build_threads"
